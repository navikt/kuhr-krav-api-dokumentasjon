...
| KUHR Public Certificate Key - JWK                                                           | /kuhr/jwk                                                | nav:kuhr/jwk<br>hdir:kuhr-krav-api/krav                             | GET/JSON  | Returnerer KUHRs offentlige nøkkel (JWK) for kryptering av POST-requests.                                             |
